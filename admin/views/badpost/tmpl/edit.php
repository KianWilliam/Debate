...
<script type="text/javascript">
	...
	{
		if (task == 'badpost.cancel' || document.formvalidator.isValid(document.id('badpost-form'))) {
			               Joomla.submitform(task, document.getElementById('badpost-form'));
		}
...
<form action="<?php echo Route::_('index.php?option=com_debate&view=badpost&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="badpost-form" class="form-validate">
               <div class="width-60 fltlft">
				    <fieldset class="adminform">
						<legend><?php echo empty($this->item->id) ? JText::_('COM_DEBATE_NEW') : JText::sprintf('COM_DEBATE_BAD_POST_SETTINGS', $this->item->id); ?></legend>
						<ul class="adminformlist">
				                  ...
				                  <?php echo $this->form->getInput('userid'); ?></li>								  
				              	  ...
				              	  <li><?php echo $this->form->getLabel('baddate'); ?>
				                  <?php echo $this->form->getInput('baddate'); ?></li>	
