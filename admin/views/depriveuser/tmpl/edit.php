...
<script type="text/javascript">
	...
	{
		if (task == 'depriveuser.cancel' || document.formvalidator.isValid(document.id('depriveuser-form'))) {
			Joomla.submitform(task, document.getElementById('depriveuser-form'));
		}
		else {
...
<form action="<?php echo Route::_('index.php?option=com_debate&view=depriveuser&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="depriveuser-form" class="form-validate">
