...
class DebateViewMessage extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		$title = Text::_('COM_DEBATE')." - ";
			$title .= $this->item->title." <small>[".Text::_("COM_DEBATE_EDIT_SETTINGS")."]</small>";
		
		ToolBarHelper::title($title   , 'generic.png' );
		
			ToolBarHelper::custom('message.saveBeta','save.png', 'save.png', 'Save & Close', false, false);

			ToolBarHelper::cancel('message.cancel', 'JTOOLBAR_CANCEL');
